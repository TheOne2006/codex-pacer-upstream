    ...
    settings: {
      ...
      sections: {
        ...
        sync: {
          ...
          remoteAutoUpdateEnabled: 'Remote auto tracking enabled',
          remoteAutoUpdateEnabledNote: 'Periodically updates sources checked in the remote source manager.',
          remoteAutoUpdateIntervalMinutes: 'Remote tracking interval (minutes)',
        ...
        menuBar: {
          ...
          liveMetricUsedPercent: 'Used percent / cost',
          liveMetricSuggestedUsageSpeed: 'Suggested usage speed %',
          liveMetricNote: '`Cost = 100% - remaining quota`; `Suggested usage speed % = remaining quota ÷ remaining time share × 100%`. `100%` means the pace is balanced; lower means you are burning quota faster, higher means you can be more aggressive.',
