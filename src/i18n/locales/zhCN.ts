    ...
    settings: {
      ...
      sections: {
        ...
        sync: {
          ...
          remoteAutoUpdateEnabled: '启用远程自动追踪',
          remoteAutoUpdateEnabledNote: '按周期更新远程数据源管理中勾选的数据源。',
          remoteAutoUpdateIntervalMinutes: '远程追踪间隔（分钟）',
        ...
        menuBar: {
          ...
          liveMetricUsedPercent: '已用百分比 / Cost',
          liveMetricSuggestedUsageSpeed: '建议使用速度百分比',
          liveMetricNote: '`Cost = 100% - 剩余额度`；`建议使用速度百分比 = 剩余额度 ÷ 剩余时间占比 × 100%`。`100%` 表示节奏健康；越低说明用得越快，越高说明还能更积极使用。',
          quotaSource: '托盘额度来源',
